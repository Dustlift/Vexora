...
import { Activity, Coins, Droplets, GalleryHorizontalEnd, LayoutDashboard, Repeat2, Rocket, Wand2 } from "lucide-react";
      ...
      <header className="sticky top-0 z-30 border-b border-white/10 bg-slate-950/80 backdrop-blur">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-4 lg:flex-row lg:items-center lg:justify-between">
          <Link href="/" className="flex items-center gap-3">
            <span className="grid size-10 place-items-center rounded-md bg-emerald-300 text-slate-950"><Coins size={21} /></span>
            <span>
              <span className="block text-base font-semibold text-white">Arc Testnet Tools</span>
              <span className="block text-xs text-slate-400">Technical operations on Arc Testnet</span>
            </span>
          </Link>
          <WalletStatus />
        </div>
